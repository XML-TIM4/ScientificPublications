...
public class ScientificPaperServiceTests {
    ...
    static String scientificPaper;

    @BeforeAll
    static void setup() {
        scientificPaper = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
    ...
    void testXSLT() throws Exception {
        ...
        String result = xslTransformer.generateHTML(scientificPaper, ".\\data\\xsl" +
    ...
    @Test
    void create_validScientificPaperPDF_equals() throws Exception {
        ...
        InputStream jo = scientificPaperService.getScientificPaperPDF(id).getInputStream();
        File file = new File("scientificPaper.pdf");
