...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <html>
            <head>
                <title><xsl:value-of select="sc:scientific-paper/sc:title"/></title>
            </head>

            <body style="padding-left:10%; padding-right:10%">
                <br/><h1 align="center"><xsl:value-of select="sc:scientific-paper/sc:title"/></h1>
                ...
                <xsl:for-each select="sc:scientific-paper/sc:abstract/sc:abstract-item"><b><xsl:value-of select="@title"/>: </b><xsl:value-of select="."/><br/></xsl:for-each>
                <br/><b>Keywords: </b><xsl:for-each select="sc:scientific-paper/sc:metadata/sc:keywords/sc:keyword">
